...
class NoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notice" do
    assert_difference("Notice.count") do
      post notices_url, params: { notice: { active: @notice.active, date: @notice.date, description: @notice.description, title: @notice.title } }, as: :json
    end
  ...
  test "should update notice" do
    patch notice_url(@notice), params: { notice: { active: @notice.active, date: @notice.date, description: @notice.description, title: @notice.title } }, as: :json
    assert_response :success
  end
